...
#     orders = db.query(LaundryOrder).order_by(LaundryOrder.request_date.desc()).limit(limit).all()
#     for order in orders:
#         activities.append({
#             "type": "laundry_order",
...
#     reports = db.query(LossReport).order_by(LossReport.report_date.desc()).limit(limit).all()
